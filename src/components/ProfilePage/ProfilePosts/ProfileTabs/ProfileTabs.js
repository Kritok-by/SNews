...
export default function ProfileTabs({user}) {
  const [value, setValue] = useState(0),
        ...
        [currUrl, setCurrUrl] = useState(`https://conduit.productionready.io/api/articles?author=${user}&limit=10&offset=`),
    ...
    <div className="tabs-container">
      <AppBar position="static" color="default">
        ...
        >
          ...
          <Tab label="Favorited Posts" onClick={()=>setCurrUrl(favoritedUrl)}/>
        </Tabs>
      </AppBar>
    </div>
  )
